Public Class Form6
    ...
    Sub MoveTo(p As PictureBox, distx As Integer, disty As Integer)
        ...
        If p.Name = "PaperFIRE" And Collision(p, "PictureBox1", other) Or
                p.Name = "Paper2FIRE" And Collision(p, "PictureBox1", other) Then
            p.Location += New Point(distx, disty)
        ...
        End If
        If p.Name = "BULLET" And Collision(p, "PaperFIRE", other) Or
                p.Name = "BULLET" And Collision(p, "Paper2FIRE", other) Then
            other.visible = False
            MoveTo(other, 10000, 10000)
            BULLET.Visible = False
            MoveTo(BULLET, 10000, 10000)
        End If
        If p.Name = "Asteroid3WALL" And Collision(p, "PaperFIRE", other) Then
            PaperFIRE.Visible = False
            MoveTo(PaperFIRE, 10000, 10000)
        End If
        If p.Name = "PictureBox3WALL" And Collision(p, "Paper2FIRE", other) Then
            Paper2FIRE.Visible = False
            MoveTo(Paper2FIRE, 10000, 10000)
        End If
        ...
        If p.Name = "BULLET" And Collision(p, "CraneBOSS", other) Then
            ...
            End If
        End If
        If p.Name = "BULLET" And Collision(p, "Crane2BOSS", other) Then
            BULLET.Visible = False
            MoveTo(BULLET, 10000, 10000)
            hp2 = hp2 - 1
            If hp = 0 Then
